...
These are Path of Exile pricing data crunched from our Discord Server and generate outputs to PoE Hub pricing channels. Most of the data are only available exclusively from Poe Hub such as
...
The file paths are subject to change if and when there are any channel changes made in the PoE Hub Discord. 
...
We do recommend you to follow our [#tool-dev-updates](https://discord.com/channels/1041808062442381393/1486909569434259557) channel for future updates, this channel is available as a "news" channel on Discord so that you can pull the update feed into a Discord of your own choosing also.
